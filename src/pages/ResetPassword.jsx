...
const ResetPassword = () => {
  ...
  return (
    <MainLayout>
      <div className="min-h-[85vh] flex flex-col justify-center items-center px-4 py-12 w-full font-display bg-gray-50">
        <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 p-10 animate-in zoom-in-95 duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
                <div className="relative">
                    ...
                    <div className="relative flex items-center bg-gray-50 rounded-2xl border border-gray-200 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                        <div className="pl-4 text-gray-400"><MdLock size={20} /></div>
                        <input
                            type={showPassword ? "text" : "password"}
                            className="w-full py-4 px-4 bg-transparent outline-none text-gray-800 font-bold"
                            placeholder="••••••••"
                            value={password}
